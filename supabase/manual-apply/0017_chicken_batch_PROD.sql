...
union all select id, 'Œuf', 1, 'piece' from public.recipes where name = 'Poulet katsu, riz & salade de chou'
...
union all select id, 'Carotte', 40, 'g' from public.recipes where name = 'Poulet katsu, riz & salade de chou'
