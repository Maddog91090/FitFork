...
```
supabase/migrations/
  0002_recipes_and_meal_plans.sql   # recipes, recipe_ingredients (public read-only) + weekly_meal_plans, meal_plan_entries (RLS) + seed data
src/lib/
